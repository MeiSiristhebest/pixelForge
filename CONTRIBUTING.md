...
We love your input! We want to make contributing to pixelForge as easy and transparent as possible, whether it's:
...
2. Clone your fork: `git clone https://github.com/yourusername/pixelForge.git`
3. Start infrastructure: `docker-compose up -d`
4. Install frontend dependencies: `cd frontend && pnpm install`
5. Install backend dependencies: `cd ../backend && pnpm install`
